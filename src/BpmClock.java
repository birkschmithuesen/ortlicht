...
class BpmClock {
	...
	float bpm;
	float startTime = 0;
	RemoteControlledFloatParameter remoteBpm = new RemoteControlledFloatParameter("bpm", 10, 5, 200);
	...
	public void update() {
		...
		cyclePos = papplet.millis() / (60000 / bpm);
		cyclePos = cyclePos - papplet.floor(cyclePos);
